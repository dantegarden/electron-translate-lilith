...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            freshRawDisplay(){
                ...
                if(this.chapterInfo.workONRow> this.currentStep){
                    ...
                    while(startIndex < endIndex){
                        let cloneSentence = Object.assign({},this.rawSentenceList[startIndex])
            ...
            useTranslate(source){
                var text = "";
                if(source=="tencent"){text = this.TencentText}
                else if(source=="caiyun"){text = this.CaiyunText}
                else if(source=="mine"){text = this.MyText}

                let currentRaw = this.currentRawRow;
                let old_tran_sentence = this.$db.get('trans_sentence')
                ...
                if(!old_tran_sentence){
                    ...
                    let oldWordsNum = old_tran_sentence.wordsNum
